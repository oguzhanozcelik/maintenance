  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8">
      ...
      <div className="text-center text-gray-900 font-weight-bold mt-8 mb-8">
        <h1 className="text-3xl mb-3">Bakımdayız</h1>
        <p className="text-xl mb-5">Websitemiz bakım modundadır. Çok yakında tekrar yayında olacağız!</p>
      </div>

      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-1 lg:text-left">
        <a
          href="tel:+905546547500"
